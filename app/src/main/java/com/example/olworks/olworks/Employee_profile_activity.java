...
public class Employee_profile_activity extends Fragment {

    CheckBox partTime, fullTime;
    ImageView profileImage, editProfile;
    TextView aboutYou, experience, names, education, location;
    DatabaseReference databaseReference;
    String authUid;
    String Experience, AboutYou, FirstName, Othername, ProfileImage, AddressLocation, Education;
    ...
    public Employee_profile_activity() {
    }

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View rootview =  inflater.inflate(R.layout.fragment_profile_employee, container, false);
        ...
        education = (TextView) rootview.findViewById(R.id.textViewEducation);
        experience = (TextView) rootview.findViewById(R.id.textViewWorkExp);
        names = (TextView) rootview.findViewById(R.id.textViewNames);
        aboutYou = (TextView) rootview.findViewById(R.id.textViewDescription);
        ...
        profileInfo.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (Education == null){
                    Education = "Add An Education";
                }
                education.setText(Education);
                Experience = map.get("experience");
                if (Experience == null){
                    Experience = "What is Your Job Experience";
                }
        ...
        editProfile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent editProfile = new Intent(getActivity(), Edit_employee_profile_activity.class);
                Bundle bundle = new Bundle();
                bundle.putString("firstName", FirstName);
                bundle.putString("otherName", Othername);;
                bundle.putString("desc", AboutYou);;
